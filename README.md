Develop a command line that can parse and process both CAR (XML) and CSV files, then display their contents according to specific criteria. The system should: 
